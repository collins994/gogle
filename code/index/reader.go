/*
	THOUGHTS:
		maybe if readNormalized read a []byte, we could normalize on the fly
*/
...
func (reader *fileReader) readNormalized(skipWhiteSpace bool, consumeFirstCharacter bool) (byte, int) {
	var (
...
//  	-	remove punctuation
// 		- normalize unicode
// to discard bytes, pass targetBuffer nil
// func (reader *fileReader) readNormalized(skipWhiteSpace bool, consumeFirstCharacter bool) (byte, int) {
// 	var (
// 		numberOfSpacesSkipped int = 0
// 		nextbyte              byte
...
// 	}
// 	if size > 1 {
// 		if nextbyte, ok = baseRune[nextCharacter]; !ok { // unicode normalization
// 			goto read // ignore any character we cannot decompose
// 		}
// 	}
// 	nextbyte = byte(nextCharacter);
// 	if ignorePunctuation[nextbyte] { // ignore punctuations
// 		goto read
// 	}
//
// 	if nextbyte >= 'A' && nextbyte <= 'Z' {
